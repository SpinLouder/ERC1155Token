...
contract SpinLouder is ERC1155, ERC2981, Ownable {
    using Strings for uint256;

    uint256 public price = 100000000000000; //0.0001
    string public baseURI;
    // Contract name
    string public name = "SpinLouder";
    ...
    function rescueERC721(address tokenAddress, uint256 tokenId, address to) external onlyOwner {
        ...
        require(token.ownerOf(tokenId) == address(this), "This contract does not own the token");
